...
// const marchBerry = "0x8FB343F8fe21bcce23173b6975050eE8B1b5b65A";
// const v2berry = "0x6CC73A7cb32B5978dA026b8fB8A33C080a9a0Fe4";
...
console.log("Mainnet address: ", berryMasterAddress);
...
module.exports =async function(callback) {
  ...
  if (gasP < 50000000000){
    ...
    for(i=1;i<52;i++){
       let count = await berryMaster.getNewValueCountbyRequestId(i);
       let lastTime = await berryMaster.getTimestampbyRequestIDandIndex(i, count - 1); //will this work with a zero index? (or insta hit?)
    ...
    console.log('<https://etherscan.io/address/',berryMasterAddress,'>')
