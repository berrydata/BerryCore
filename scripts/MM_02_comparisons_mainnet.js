...
module.exports =async function(callback) {
    ...
    let stakerCount;
    let disputeCount;
    stakerCount = await berryMaster.getUintVar(web3.utils.keccak256("stakerCount"));
    console.log("stakercount",  web3.utils.hexToNumberString(stakerCount));
    disputeCount = await berryMaster.getUintVar(web3.utils.keccak256("disputeCount"));
    console.log("diputecount",  web3.utils.hexToNumberString(disputeCount));
/*    let last = await berryMaster.getUintVar(web3.utils.keccak256("timeOfLastNewValue"));
...
*/
    ...
    //         let ttbalanceNow = await berryMaster.balanceOf(minerAddress);
