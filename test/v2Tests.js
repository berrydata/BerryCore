...
//         from: accounts[0],
//         gas: 7000000,
//         data: oldBerryinst.methods.requestData(apix, x, 1000, 0).encodeABI(),
//       });
//     }
...
//     assert(dispInfo[2] == true, "Dispute Vote passed");
//     assert(
//       (await oracle.getAddressVars(web3.utils.keccak256("berryContract"))) !=
//         oracleBase2.address
//     );
//     await web3.eth.sendTransaction({
//       to: oracle.address,
...
//         from: accounts[0],
//         gas: 7000000,
//         data: oracle2.methods.updateBerry(1).encodeABI(),
//       })
//     ); //try to withdraw
//     await helper.advanceTime(86400 * 8);
//     await helper.expectThrow(
...
//         from: accounts[0],
//         gas: 7000000,
//         data: oracle2.methods.updateBerry(2).encodeABI(),
//       })
//     );
//     assert(
//       (await oracle.getAddressVars(web3.utils.keccak256("berryContract"))) !=
